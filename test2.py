...
def main():
    cap = cv2.VideoCapture('/Users/emplv/Projects/sticktok/backend/media/jurg.is.mp4')
    cap2 = cv2.VideoCapture('/Users/emplv/Projects/sticktok/backend/media/jurgzz.mp4')
    output_path = '/Users/emplv/Projects/sticktok/backend/media/pose.mp4'
